 ...
 * 
 */
export function updateTrackingPropertyAllowList(allowList: {
  adding?: TrackingProperty[];
  removing?: TrackingProperty[];
  addingCustomEvents?: TrackingProperty[];
  removingCustomEvents?: TrackingProperty[];
  addingCustomAttributes?: TrackingProperty[];
  removingCustomAttributes?: TrackingProperty[];
})
 ...
 */
export function setAdTrackingEnabled(adTrackingEnabled: string, googleAdvertisingId: string);
 ...
 */
export function setLastKnownLocation(latitude: number, longitude: number, altitude: number, horizontalAccuracy: number, verticalAccuracy: number);
 ...
 */
export function subscribeToInAppMessage(successCallback: (inAppMessages: object[]) => void, errorCallback: (error) => void, useBrazeUI?: boolean);

/**
 * Hides the currently displayed in-app message.
 */
export function hideCurrentInAppMessage();

/**
 * Logs an impression for the provided in-app message data.
 * @param {BrazeInAppMessage} inAppMessage
 */
export function logInAppMessageImpression(inAppMessage: object);

/**
 * Logs a click for the provided in-app message data.
 * @param {BrazeInAppMessage} inAppMessage
 */
export function logInAppMessageClicked(inAppMessage: object);
 ...
 */
export function logInAppMessageButtonClicked(inAppMessage: object, buttonId: number);

/**
 * Performs the action for an in-app message.
 * @param {BrazeInAppMessage} inAppMessage
 */
export function performInAppMessageAction(inAppMessage: object);
 ...
 * @param {integer} buttonId
 */
export function performInAppMessageButtonAction(inAppMessage: object, buttonId: number);
 ...
 */
export function getFeatureFlag(id: string): Promise<unknown>;
